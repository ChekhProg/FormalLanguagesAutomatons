...
case class NFAEpsData(states: Set[String],
                   alphabet: Set[String],
                   transitions: Map[String, Map[String, Set[String]]],
                   initialState: String,
                   finalStates: Set[String])

object NFAEpsDeserializer {
  def deserialize(path: String): NFAEps = {
    ...
    val tempFSM = jsonObject.extract[NFAEpsData]
    ...
    new NFAEps(states, alphabet, transitions, initialState, finalStates, Set(initialState))
  }
}
